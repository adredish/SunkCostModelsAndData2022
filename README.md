This code provides a new implementation of the model from Ott et al. 2022 and tests is against hypotheses from our Restaurant Row and WebSurf data.   It generates the figures provided in our response.
